...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">{{ __('S\'inscrire') }}</div><br>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <!-- Mot de passe -->
                        <div class="form-group row">
                            <label for="mot_de_passe" class="col-md-4 col-form-label text-md-right">{{ __('Mot de passe') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="mot_de_passe_confirmation" class="col-md-4 col-form-label text-md-right">{{ __('Confirmer le mot de passe') }}</label>

                            <div class="col-md-6">
                                <input id="mot_de_passe_confirmation" type="password" class="form-control" name="mot_de_passe_confirmation" required>
                            </div>
                        </div><br>
